...
export const T: Dict = {
  ...
  tagline: { en: "Hospital OPD self check-in", hi: "अस्पताल ओपीडी स्वयं पंजीकरण" },
  ...
  dropHere: { en: "Drag & drop, or choose a file / use camera", hi: "यहाँ खींचें, या फ़ाइल चुनें / कैमरा उपयोग करें" },
